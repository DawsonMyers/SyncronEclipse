 ...
 *
 */
public class UdpNodeReceiver extends AbstractUdpDispatcher implements IUdp {

	// AbstractUdpHandler mHandler = null;
	public final static Logger	log		= LoggerFactory.getLogger(UdpNodeReceiver.class.getName());
	public static MsgTimer		timer	= new MsgTimer();

	public UdpNodeReceiver() {}

	public UdpNodeReceiver(AbstractUdpHandler handler) {
		super(handler);
		// mHandler = handler;
	}
